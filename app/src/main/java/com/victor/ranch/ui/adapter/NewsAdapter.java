 ...
 * -----------------------------------------------------------------
 */
public class NewsAdapter extends BaseRecycleAdapter<NewsInfo, RecyclerView.ViewHolder> {
    public NewsAdapter(Context context, AdapterView.OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateContentVHolder(ViewGroup parent, int viewType) {
        View rootView = getLayoutView(R.layout.rv_news_cell,parent);
