 ...
 * -----------------------------------------------------------------
 * File: ProductListAdapter
 * Author: Victor
 * Date: 2020/5/29 上午 08:31
 * Description:
 * -----------------------------------------------------------------
 */
public class ProductListAdapter extends BaseRecycleAdapter<NewsInfo, RecyclerView.ViewHolder> {
    public ProductListAdapter(Context context, AdapterView.OnItemClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateContentVHolder(ViewGroup parent, int viewType) {
        View rootView = getLayoutView(R.layout.rv_product_list_cell,parent);
        return new ProductListViewHolder(rootView);
    }
    ...
    public void onBindContentVHolder(RecyclerView.ViewHolder viewHolder, NewsInfo data, int position) {
        ProductListViewHolder holder = (ProductListViewHolder) viewHolder;
